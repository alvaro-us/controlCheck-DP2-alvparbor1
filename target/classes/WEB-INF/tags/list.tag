...
<table id="list" class="table table-striped table-condensed table-hover nowrap w-100">
	...
	<thead>
		<tr>
			<th class="control"><%-- Placeholder for details button --%></th>
...
<acme:message var="__i18nFileUri" code="default.datatables.language"/>
<jstl:set var="language" value="'language': { 'url': getAbsoluteUrl('${__i18nFileUri}') }"/>
